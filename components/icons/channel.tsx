...
export const TextChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export const LockedTextChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export const VoiceChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
      fill="currentColor"
...
export const ThreadChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
...
export const ForumChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
      fill="currentColor"
...
export const PostChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
      fill="currentColor"
...
export const GuideChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
      fill="currentColor"
...
export const BrowseChannelIcon: IconFC = (props:any) => (
  <Svg {...props}>
    <path
      fillRule="evenodd"
