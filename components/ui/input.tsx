  ...
  return (
    <input
      ...
      className={cn(
        ...
        "flex h-[36px] w-full rounded-[8px] bg-surface-high px-3 py-2 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none border border-border-subtle focus:border-[#5197ed] disabled:cursor-not-allowed disabled:opacity-50",
        "aria-invalid:border-text-danger aria-invalid:focus:border-text-danger",
        className
      )}
